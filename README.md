...
- [door](https://github.com/Alimektor/door) ![door License](https://img.shields.io/github/license/Alimektor/door.svg?style=plastic) ![door Language](https://img.shields.io/github/languages/top/Alimektor/door.svg?style=plastic) ![door Language](https://img.shields.io/github/stars/Alimektor/door.svg?style=plastic) — A high-performance Go-based firewall with client/server architecture implementing Port Knocking security through nftables for protecting network services.
...
- [docker-renpy](https://github.com/Alimektor/docker-renpy) ![docker-renpy License](https://img.shields.io/github/license/Alimektor/docker-renpy.svg?style=plastic) ![docker-renpy Language](https://img.shields.io/github/languages/top/Alimektor/docker-renpy.svg?style=plastic) ![docker-renpy Language](https://img.shields.io/github/stars/Alimektor/docker-renpy.svg?style=plastic) — A Docker image for Ren'Py providing a pre-built, isolated development environment that enables seamless CI/CD integration for consistent automated testing, building, and deployment of visual novel projects across any platform while maintaining identical runtime conditions.
