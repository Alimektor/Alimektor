...
def get_github_projects():
    gh_command = "gh repo list --json owner,name,description,url,isArchived,isPrivate,isFork"
...
def get_public_github_projects():
    ...
    return [project for project in projects if not project["isArchived"] and not project["isPrivate"] and not project["isFork"] and not project["name"] == "Alimektor" and not project["name"] == "alimektor.github.io"]
